...
export const Floor= ({ navigation }) => {
    return (
        <View style={globalStyle.container}>
            ...
            <Text style={[globalStyle.text, WallsStyles.text, WallsStyles.boldText]}>Підлога</Text>
            <Image style={WallsStyles.pointer} source={require("../assets/images/downPointer.png")}/>
            <TouchableOpacity>
                <Text style={[globalStyle.text, WallsStyles.text, WallsStyles.clicker]}>Облицювання</Text>
            </TouchableOpacity>
            <TouchableOpacity onPress={() => {navigation.navigate("TileFloor"); }}>
                <Text style={[globalStyle.text, WallsStyles.text, WallsStyles.clicker]}>Плитка</Text>
            </TouchableOpacity>
            <TouchableOpacity onPress={() => {navigation.navigate("RollCovers"); }}>
                <Text style={[globalStyle.text, WallsStyles.text, WallsStyles.clicker]}>Рулонне покриття</Text>
            </TouchableOpacity>
        </View>
    );
};